...
public class MansionQuery {
    ...
    public Pair<Long, List<String>> query(LuceneService luceneService) {
        ...
        final Facets facets = new FastTaxonomyFacetCounts("mansion", taxoReader, taskLucene.facetsConfig(), fc);
        final FacetResult facetResult = facets.getTopChildren(Integer.MAX_VALUE, "mansion");
